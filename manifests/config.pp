...
class statsd::config (
  ...
  $riemann_host                      = $statsd::riemann_host,
  $riemann_port                      = $statsd::riemann_port,
  $riemann_transport                 = $statsd::riemann_transport,
  $riemann_tags                      = $statsd::riemann_tags,
  $riemann_parseNamespace            = $statsd::riemann_parseNamespace,
  $riemann_tagWithEventParts         = $statsd::riemann_tagWithEventParts,
